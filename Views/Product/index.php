      ...
      <div class="container">
         <div class="box">
            <div class="arrival_bg_box">
                  <img src="/public/images/arrival-bg.png" alt="">
            </div>
            <div class="row">
               ...
               <div class="col-sm-6 col-md-4 col-lg-4">
                     <div class="box">
                        <div class="option_container">
                           <div class="options">
                                 <a href="/index.php?controller=product&action=detail&id=<?php echo $product['id']; ?>" class="option1">
                                    Detail
                                 </a>
                                 <a href="/index.php?controller=cart&action=addToCart&productID=<?php echo $product['id']; ?>" class="option1">
                                    Add to cart
                                 </a>
                           </div>
                        </div>
                        <div class="img-box">
                           <img src="\Public\images\<?php echo $product['img'] ?>" alt="">
                        </div>
                        <div class="detail-box">
                           <h5>
                                 <?php echo $product['name'] ?>
                           </h5>
                           <h6 class="text-danger m-3">
                     ...
                     <div class="box col-lg-10 mx-auto">
                        ...
                        <div class="detail-box">
                              ...
                              <p>
                                 ...
                                 ipsum ducimus ad labore modi voluptatibus accusantium sapiente nam! Quaerat.
                              </p>
                        </div>
                     </div>
                  </div>
